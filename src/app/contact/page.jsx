          ...
          <div className='xl:space-y-6 space-y-2 mb-4'>
            ...
            <div className='grid xl:grid-cols-2 xl:gap-6 gap-6' data-aos="fade-right">
              <div className='flex items-start gap-3'>
                ...
                <div>
                  <h4 className='text-white font-medium xl:text-base md:text-sm text-xs'>Phone</h4>
                  <p className='text-white xl:text-base md:text-sm text-xs'>+123-456-7890</p>
                </div>
              </div>
              <div className='flex items-start gap-3'>
                <FaPhone className='text-black bg-white p-1 rounded-full size-8 md:mt-1 xl:mt-2 mt-0' />
              ...
              <div className='flex items-start gap-3'>
                ...
                <div>
                  <h4 className='text-white font-medium xl:text-base md:text-sm text-xs'>E-Mail</h4>
                  <p className='text-white xl:text-base md:text-sm text-xs'>diamondatelierusa@gmail.com</p>
                </div>
              </div>
              <div className='flex items-start gap-3'>
                <SlGlobe className='text-black bg-white p-1 rounded-full size-8 md:mt-1 xl:mt-2 mt-0' />
                <div>
                  <h4 className='text-white font-medium xl:text-base md:text-sm text-xs'>Website</h4>
                  <p className='text-white xl:text-base md:text-sm text-xs'>www.diamondatelier.com</p>
                </div>
              </div>
              <div className='flex items-start gap-3 md:col-span-2'>
                <FaLocationDot className='text-black bg-white p-1 rounded-full size-8 md:mt-1 xl:mt-2 mt-0' />
                <div>
                  <h4 className='text-white font-medium xl:text-base md:text-sm text-xs'>Address</h4>
                  <p className='text-white xl:text-base md:text-sm text-xs'>38 West 48th Street, 5th Floor, New York, NY 10036</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className='bg-[#d9d9d9] rounded-2xl shadow-xl xl:p-6 md:p-4 p-6'>
              <form className="xl:space-y-4 space-y-1" onSubmit={handleSubmit}>
                ...
                <div className="text-center">
                  <button type="submit" className="bg-[#111c4f] text-white rounded-full px-8 xl:py-2 py-1 text-base font-medium hover:bg-[#0e1740] transition">
                    Submit
                  </button>
                </div>
              </form>
