    ...
    <>
      ...
      >
          ...
          <motion.div
            ...
            whileInView="visible"
            viewport={{ once: false, amount: 0.2 }}
            className="text-center xl:text-left xl:w-1/2 mt-8 xl:mt-0"
          >
            <h2 className="text-white font-bold xl:text-4xl md:text-2xl text-xl px-4 uppercase">
              {item.title}
            </h2>
            {item.subtitle && (
            ...
            <p className="text-[#d9d9d9] font-normal xl:text-xl md:text-md text-sm px-4 mt-4 leading-extended">
              {item.description}
            </p>
          </motion.div>
        </section>
